...
abstract class Server implements Server\Driver
{
    ...
    protected function _initRunTime()
    {
        ...
        $this->processName = $mainSetting['process_name'] ? $mainSetting['process_name'] : $mainSetting['server_class'];
        ...
        $this->serverClass = $mainSetting['server_class'] ? $mainSetting['server_class'] : '';
